"""
This script is used to train and evaluate a base model for the survival prediction of lung cancer patients.
It was created in the context of the review given by the Red. 
