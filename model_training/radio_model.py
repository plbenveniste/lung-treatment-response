""""
This script is used to train and evaluate the model for survival prediction only on clinical data
...
Example run:
    python clini_model.py --input /path/to/merged.csv --output /path/to/output_folder
...
def main():
    ...
    # Clear the log file
    log_file = os.path.join(output_folder, f'radio_model_{nb_years}_years.txt')
    ...
    radio_columns = ['MORPHOLOGICAL_Volume', 'MORPHOLOGICAL_ApproximateVolume', 'MORPHOLOGICAL_voxelsCounting', 'MORPHOLOGICAL_SurfaceArea', 'MORPHOLOGICAL_SurfaceToVolumeRatio',
                    'MORPHOLOGICAL_Compacity', 'MORPHOLOGICAL_Compactness1', 'MORPHOLOGICAL_Compactness2', 'MORPHOLOGICAL_SphericalDisproportion', 'MORPHOLOGICAL_Sphericity',
                    'MORPHOLOGICAL_Asphericity', 'MORPHOLOGICAL_CentreOfMassShift', 'MORPHOLOGICAL_Maximum3DDiameter', 'MORPHOLOGICAL_SphereDiameter', 'MORPHOLOGICAL_IntegratedIntensity',
                    'INTENSITY-BASED_MeanIntensity', 'INTENSITY-BASED_IntensitySkewness', 'INTENSITY-BASED_IntensityKurtosis', 'INTENSITY-BASED_MedianIntensity', 'INTENSITY-BASED_MinimumIntensity',
                    'INTENSITY-BASED_10thIntensityPercentile', 'INTENSITY-BASED_25thIntensityPercentile', 'INTENSITY-BASED_50thIntensityPercentile', 'INTENSITY-BASED_75thIntensityPercentile',
                    'INTENSITY-BASED_90thIntensityPercentile', 'INTENSITY-BASED_StandardDeviation', 'INTENSITY-BASED_MaximumIntensity', 'INTENSITY-BASED_IntensityInterquartileRange',
                    'INTENSITY-BASED_IntensityRange', 'INTENSITY-BASED_IntensityBasedMeanAbsoluteDeviation', 'INTENSITY-BASED_IntensityBasedRobustMeanAbsoluteDeviation',
                    'INTENSITY-BASED_IntensityBasedMedianAbsoluteDeviation', 'INTENSITY-BASED_AreaUnderCurveCIVH', 'INTENSITY-BASED_IntensityBasedEnergy', 'INTENSITY-BASED_RootMeanSquareIntensity',
                    'INTENSITY-BASED_TotalLesionGlycolysis', 'LOCAL_INTENSITY_BASED_GlobalIntensityPeak', 'LOCAL_INTENSITY_BASED_LocalIntensityPeak', 'INTENSITY-HISTOGRAM_IntensityHistogramMean',
                    'INTENSITY-HISTOGRAM_IntensityHistogramVariance', 'INTENSITY-HISTOGRAM_IntensityHistogramSkewness', 'INTENSITY-HISTOGRAM_IntensityHistogramKurtosis', 'INTENSITY-HISTOGRAM_IntensityHistogramMedian',
                    'INTENSITY-HISTOGRAM_IntensityHistogramMinimumGreyLevel', 'INTENSITY-HISTOGRAM_IntensityHistogram10thPercentile', 'INTENSITY-HISTOGRAM_IntensityHistogram25thPercentile',
                    'INTENSITY-HISTOGRAM_IntensityHistogram50thPercentile', 'INTENSITY-HISTOGRAM_IntensityHistogram75thPercentile', 'INTENSITY-HISTOGRAM_IntensityHistogram90thPercentile',
                    'INTENSITY-HISTOGRAM_IntensityHistogramStd', 'INTENSITY-HISTOGRAM_IntensityHistogramMaximumGreyLevel', 'INTENSITY-HISTOGRAM_IntensityHistogramMode',
                    'INTENSITY-HISTOGRAM_IntensityHistogramInterquartileRange', 'INTENSITY-HISTOGRAM_IntensityHistogramRange', 'INTENSITY-HISTOGRAM_IntensityHistogramMeanAbsoluteDeviation',
                    'INTENSITY-HISTOGRAM_IntensityHistogramRobustMeanAbsoluteDeviation', 'INTENSITY-HISTOGRAM_IntensityHistogramMedianAbsoluteDeviation', 'INTENSITY-HISTOGRAM_IntensityHistogramCoefficientOfVariation',
                    'INTENSITY-HISTOGRAM_IntensityHistogramQuartileCoefficientOfDispersion', 'INTENSITY-HISTOGRAM_IntensityHistogramEntropyLog10', 'INTENSITY-HISTOGRAM_IntensityHistogramEntropyLog2',
                    'INTENSITY-HISTOGRAM_AreaUnderCurveCIVH', 'INTENSITY-HISTOGRAM_Uniformity', 'INTENSITY-HISTOGRAM_RootMeanSquare', 'INTENSITY-HISTOGRAM_MaximumHistogramGradient',
                    'INTENSITY-HISTOGRAM_MaximumHistogramGradientGreyLevel', 'INTENSITY-HISTOGRAM_MinimumHistogramGradient', 'INTENSITY-HISTOGRAM_MinimumHistogramGradientGreyLevel',
                    'LOCAL_INTENSITY_HISTOGRAM_GlobalIntensityPeak', 'LOCAL_INTENSITY_HISTOGRAM_LocalIntensityPeak', 'GLCM_JointMaximum', 'GLCM_JointAverage', 'GLCM_JointVariance',
                    'GLCM_JointEntropyLog2', 'GLCM_JointEntropyLog10', 'GLCM_DifferenceAverage', 'GLCM_DifferenceVariance', 'GLCM_SumAverage', 'GLCM_SumVariance', 'GLCM_AngularSecondMoment',
                    'GLCM_Contrast', 'GLCM_Dissimilarity', 'GLCM_InverseDifference', 'GLCM_NormalisedInverseDifference', 'GLCM_InverseDifferenceMoment', 'GLCM_NormalisedInverseDifferenceMoment',
                    'GLCM_InverseVariance', 'GLCM_Correlation', 'GLCM_Autocorrelation', 'GLCM_ClusterTendency', 'GLCM_ClusterShade', 'GLCM_ClusterProminence', 'GLRLM_ShortRunsEmphasis',
                    'GLRLM_LongRunsEmphasis', 'GLRLM_LowGreyLevelRunEmphasis', 'GLRLM_HighGreyLevelRunEmphasis', 'GLRLM_ShortRunLowGreyLevelEmphasis', 'GLRLM_ShortRunHighGreyLevelEmphasis',
                    'GLRLM_LongRunLowGreyLevelEmphasis', 'GLRLM_LongRunHighGreyLevelEmphasis', 'GLRLM_GreyLevelNonUniformity', 'GLRLM_RunLengthNonUniformity', 'GLRLM_RunPercentage',
                    'NGTDM_Coarseness', 'NGTDM_Contrast', 'NGTDM_Busyness', 'NGTDM_Complexity', 'NGTDM_Strength', 'GLSZM_SmallZoneEmphasis', 'GLSZM_LargeZoneEmphasis',
                    'GLSZM_LowGrayLevelZoneEmphasis', 'GLSZM_HighGrayLevelZoneEmphasis', 'GLSZM_SmallZoneLowGreyLevelEmphasis', 'GLSZM_SmallZoneHighGreyLevelEmphasis', 'GLSZM_LargeZoneLowGreyLevelEmphasis',
                    'GLSZM_LargeZoneHighGreyLevelEmphasis', 'GLSZM_GreyLevelNonUniformity', 'GLSZM_NormalisedGreyLevelNonUniformity', 'GLSZM_ZoneSizeNonUniformity', 'GLSZM_NormalisedZoneSizeNonUniformity',
                    'GLSZM_ZonePercentage', 'GLSZM_GreyLevelVariance', 'GLSZM_ZoneSizeVariance', 'GLSZM_ZoneSizeEntropy']

    # Split into features and target
    y = data_grouped[['DC', 'delai_fin_DC']]
    x = data_grouped[radio_columns]
