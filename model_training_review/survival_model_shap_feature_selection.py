...
def parse_args():
    ...
    parser.add_argument('--optim_all', action='store_true', help='Whether to perform bayesian optimisation or not')
    parser.add_argument('--optim_20', action='store_true', help='Whether to perform bayesian optimisation or not for 20 features')
    parser.add_argument('--optim_15', action='store_true', help='Whether to perform bayesian optimisation or not for 15 features')
    parser.add_argument('--optim_10', action='store_true', help='Whether to perform bayesian optimisation or not for 10 features')
    parser.add_argument('--optim_5', action='store_true', help='Whether to perform bayesian optimisation or not for 5 features')
...
def main():
    ...
    if args.optim_20:
        ...
        # Model training 
        model = XGBClassifier(seed=42, colsample_bytree=0.001, learning_rate=0.5, max_depth=9, n_estimators=736, subsample=0.35772144836892517)
        model.fit(x_train, y_train)

    elif test_set_letter == 'R':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.001, learning_rate=0.16827613669264055, max_depth=10, n_estimators=726, subsample=0.8684478879409514)
        model.fit(x_train, y_train)
    
    elif test_set_letter == 'T':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.001, learning_rate=0.001, max_depth=8, n_estimators=10, subsample=0.976808479501675)
        model.fit(x_train, y_train)
    ...
    if args.optim_15:
        ...
        # Model training 
        model = XGBClassifier(seed=42, colsample_bytree=0.2027128095079519, learning_rate=0.2581018891214026, max_depth=10, n_estimators=1000, subsample=0.1)
        model.fit(x_train, y_train)

    elif test_set_letter == 'H':
        # Model training 
        model = XGBClassifier(seed=42, colsample_bytree=1.0, learning_rate=0.19531336359362558, max_depth=3, n_estimators=1000, subsample=0.5949941898078429)
        model.fit(x_train, y_train)

    elif test_set_letter == 'R':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.14099395274954613, learning_rate=0.03927468588095187, max_depth=9, n_estimators=708, subsample=1.0)
        model.fit(x_train, y_train)

    elif test_set_letter == 'T':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.07233821058724935, learning_rate=0.021691672748342217, max_depth=3, n_estimators=224, subsample=0.7674150306564929)
        model.fit(x_train, y_train)
    ...
    if args.optim_10:
        ...
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.4711360678857827, learning_rate=0.001, max_depth=3, n_estimators=1000, subsample=0.1250920068305991)
        model.fit(x_train, y_train)

    elif test_set_letter == 'H':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.06719913147457253, learning_rate=0.17168383390078637, max_depth=10, n_estimators=10, subsample=0.8413888880462014)
        model.fit(x_train, y_train)

    elif test_set_letter == 'R':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.07293769315494704, learning_rate=0.001, max_depth=7, n_estimators=10, subsample=0.6768936895172735)
        model.fit(x_train, y_train)

    elif test_set_letter == 'T':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.034476637122447334, learning_rate=0.07417142094432344, max_depth=3, n_estimators=10, subsample=1.0)
        model.fit(x_train, y_train)
    ...
    if args.optim_5:
        ...
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.001, learning_rate=0.5, max_depth=9, n_estimators=667, subsample=0.3236592732998028)
        model.fit(x_train, y_train)

    elif test_set_letter == 'H':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=1.0, learning_rate=0.4275717197557699, max_depth=3, n_estimators=265, subsample=0.810802453480628)
        model.fit(x_train, y_train)

    elif test_set_letter == 'R':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.11361248082192713, learning_rate=0.021193222066410746, max_depth=3, n_estimators=426, subsample=0.7565788438411771)
        model.fit(x_train, y_train)

    elif test_set_letter == 'T':
        # Model training
        model = XGBClassifier(seed=42, colsample_bytree=0.2422714384845286, learning_rate=0.001, max_depth=3, n_estimators=638, subsample=0.990931439380271)
        model.fit(x_train, y_train)
