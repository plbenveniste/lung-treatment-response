...
Example usage:
    python plot_feature_importance.py --model_path model.pkl --data_path data.csv --log_path training.log
...
from sklearn.metrics import (roc_auc_score, brier_score_loss, precision_score,
                             recall_score, accuracy_score, f1_score, precision_recall_curve, auc)
